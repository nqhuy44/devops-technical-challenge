...
let nodeGroupRole: aws.iam.Role;
...
try {
    ...
    nodeGroupRole = new aws.iam.Role("nodeGroupRole", {
        assumeRolePolicy: JSON.stringify({
            Version: "2012-10-17",
            Statement: [{
                Action: "sts:AssumeRole",
    ...
    cluster = new eks.Cluster(eksConfig.clusterName, {
    ...
    console.error(`Failed to provision EKS cluster: ${error}`);
}

export { cluster, nodeGroupRole, provider};